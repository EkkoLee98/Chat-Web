...
// import zhifupay from '@/assets/zhifupay.jpg'
      ...
      content: () => h('div', {
        ...
        [
          h('p', {
            ...
            //   : '',
            // h('p', { style: { fontSize: '14px' } }, '获取提问字数，字数扣除规则如下: (<= 200字，按实际字数扣除，200—500，扣除(字数/5)字数，>500，扣除(字数/10)字数)，扣除不包含回答字数')
          ]),
        ]),
      positiveText: 'OK',
    })
...
async function onConversation() {
  ...
  try {
    ...
    loading.value = false
    keyStore.recordState(keyStore.chatKey, true)
  }
}
        ...
        <div class="flex items-center justify-between space-x-2">
          ...
          <NAutoComplete v-model:value="prompt" :options="searchOptions" :render-label="renderOption">
            <template #default="{ handleInput, handleBlur, handleFocus }">
              <NInput v-model:value="prompt" show-count type="textarea" :placeholder="placeholder"
